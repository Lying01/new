    ...
    var pickerLocation = myApp.picker({
        ...
        toolbarTemplate: '<div class="toolbar">\
                            <div class="toolbar-inner">\
                                <div class="left">\
                                    <a href="#" class="link close-picker" style="color:#30B54C;">取消</a>\
                                </div>\
                                <div class="right">\
                                    <a href="#" class="link close-picker" style="color:#30B54C;">完成</a>\
                                </div>\
                            </div>\
                        </div>',
        cols: [{
...
$switch.bind('click', function () {
    if (flag) {//未选中样式
        $switch.css('border-color', '#9F9F9F');
        $switchBtn.css('left', '-25px');
        console.log("no")
    } else {//选中样式
        $switch.css('border-color', '#30B54C');
